			...
			<div className="flex items-center justify-between mb-5">
				<div>
					...
					<p className="text-xs text-neutral-400 ml-8">
						{data?.forecastHorizon} prediction horizon • Updated{" "}
						...
						>
							...
							<div className="text-right">
								<p className="text-sm font-semibold text-neutral-200">
									{item.currentStock}{" "}
									<span className="text-neutral-500 font-normal">in stock</span>
								</p>
							...
							<div
								className={`px-2.5 py-1 rounded-lg text-[11px] font-semibold ${risk.bg} ${risk.text}`}
							>
