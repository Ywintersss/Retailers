				...
				<div className="flex-1">
					...
					<div className="flex justify-between mt-1.5 text-[10px]">
						<span className="text-success">
							{sentimentBarWidth.positive}% Positive
						</span>
						<span className="text-neutral-400">
							{sentimentBarWidth.neutral}% Neutral
						</span>
						<span className="text-danger">
							{sentimentBarWidth.negative}% Negative
						</span>
					</div>
				</div>
			</div>
						...
						>
							...
							<div className="space-y-1.5 mb-3">
								{alert.reviewSnippets?.map((snippet, i) => (
									<p
										key={i}
										className="text-xs text-neutral-400 italic pl-3 border-l-2 border-neutral-700"
									>
										{snippet}
									</p>
								))}
